...
export default function Timeline() {
  const events: MissionEvent[] = [
    ...
    {
      year: "2025",
      title: "Autonomous Drone & Robotics Build",
      tag: "HARDWARE DEPLOYMENT",
      description: "Successfully built the DJI F450 autonomous quadcopter, 4WD exploration terrain rover, and TCRT-based path-tracking robot. Tuned cascade PID matrices for active hover stability.",
      icon: <Cpu className="w-4 h-4 text-neon-purple" />,
      status: "INTEGRATION SUCCESS",
    },
    {
      year: "2024",
      title: "Started B.Tech Electrical Engineering @ KGEC",
      tag: "MATRICULATION",
      description: "Enrolled in the B.Tech program at Kalyani Government Engineering College. Commenced specialized coursework in electric machine models, control engineering, and microcontrollers.",
    ...
    },
    {
      ...
      description: "Achieved state-level Top rank (3513 out of 100K+ candidates) in West Bengal Joint Entrance, alongside 96 percentile score in national Joint Entrance Examination.",
